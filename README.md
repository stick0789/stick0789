...
Ingeniero de Software con más de dos años de experiencia en desarrollo Fullstack.Actualmente, estoy pivotando mi carrera hacia la **Ciberseguridad**, combinando mi base sólida en desarrollo con técnicas avanzadas de auditoría y defensa.
...
* 🤔 **Buscando colaborar en:** Proyectos de Red Team, auditorías web y desarrollo de herramientas de seguridad.
* 💬 **Pregúntame sobre:** Cómo integrar seguridad en el ciclo de vida de desarrollo (DevSecOps) y bases de datos SQL.
* ⚡ **Fun fact:** ¡Incapaz de auditar un sistema sin una buena taza de café! ☕

---

## 📂 Repositorios Destacados
* [**MiniShell + Bonus**](https://github.com/stick0789/minishell_bonus): Creación de una propia shell de Unix. Un proyecto crítico para entender la gestión de procesos, señales y descriptores de archivos.
* [**Philosophers**](https://github.com/stick0789/Philosophers): Introducción a la concurrencia y sistemas multi-hilo. Resolución del problema de los filósofos comensales usando mutex y hilos (threads).
